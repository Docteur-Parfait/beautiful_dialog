...
class EventCardDialog extends StatelessWidget {
  static void showEventCardDialog(BuildContext context) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (BuildContext context) {
        return const EventCardDialogContent();
      },
    );
  }

  const EventCardDialog({super.key});
...
class EventCardDialogContent extends StatefulWidget {
  const EventCardDialogContent({super.key});

  @override
  State<EventCardDialogContent> createState() => _EventCardDialogContentState();
}

class _EventCardDialogContentState extends State<EventCardDialogContent> {
