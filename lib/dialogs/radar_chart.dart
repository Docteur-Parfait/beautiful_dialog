...
class RadarChartWidget extends StatefulWidget {
  ...
  final gridColor = AppColors.contentColorPurple.withOpacity(0.8);
  final titleColor = AppColors.contentColorPurple.withOpacity(0.8);
          ...
          children: [
            ...
            AspectRatio(
              ...
              child: AnimatedSwitcher(
                duration: const Duration(milliseconds: 400),
                child: RadarChart(
                  key: ValueKey<int>(selectedDataSetIndex),
                  RadarChartData(
